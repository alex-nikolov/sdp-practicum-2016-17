...
1) 1 - Да се напише функция, която приема списък от числа и връща нов списък, който се получава като всички числа на четни позиции се преместят след всички на нечетни позиции, но в обратен ред.
